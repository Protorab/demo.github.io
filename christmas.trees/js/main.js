...
$(document).ready(function () {
  ...
  $(".reviews__slider").slick({
    ...
    nextArrow:
      '<div class="reviews__slider-next reviews__slider-arrow "><span> </span><span></span></div>',
    prevArrow:
  ...
  let decorationItemSlice = 0,
    decorationItemLength = $(".decoration__grid-item").length;
  if ($(window).width() >= 800) {
    decorationItemSlice = 8;
  } else {
  ...
  $(".decoration__grid-item").slice(decorationItemSlice).slideToggle();
  $(".load__more").click(function (e) {
    if ($(".decoration__grid-item").slice(decorationItemSlice).is(":visible")) {
      $(".decoration__grid-item")
        .slice(decorationItemSlice)
        .slideToggle("slow");
